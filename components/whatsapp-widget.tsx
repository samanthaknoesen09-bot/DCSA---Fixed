...
export function WhatsAppWidget() {
  ...
  const whatsappNumber = "27719006298" // 071 900 6298 in international format (hidden from display)

  const quickMessages = [
    "Hi! I'd like to chat about my options",
    "How does debt review actually work?",
    "Can you help me figure out where I stand?",
    "I'd love to book a free consultation",
    "What does it cost? (Be honest!)",
  ]
          ...
          <Card className="shadow-xl border-green-200">
            ...
            <CardContent className="p-4 space-y-3">
              <div className="text-sm text-muted-foreground mb-4">
                <p>Hey there! We{"'"}re glad you reached out.</p>
                <p>No silly questions here — ask us anything. We{"'"}re friendly, we promise.</p>
              </div>
              ...
              <div className="pt-3 border-t">
                <Button
                  onClick={() => sendWhatsAppMessage("Hi! I'd like to chat about getting help with my finances")}
