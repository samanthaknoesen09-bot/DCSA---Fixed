...
export function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      question: "What makes DCSA (Debt Clear SA (Pty) Ltd) different?",
      content: (
        <div className="space-y-4">
          <p style={{ color: colors.charcoal }}>
            Most debt counsellors treat you like another file number. At DCSA (Debt Clear SA (Pty) Ltd), we're different:
          </p>
