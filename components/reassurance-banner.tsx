...
const reassuranceMessages = [
  ...
  "The first step is always the hardest — and you're already here.",
  "Small, steady steps lead to lasting change. You've got this.",
  "No judgment, no lectures — just genuine help when you need it most.",
  "Hundreds of South Africans have been exactly where you are — and found their way through.",
]
