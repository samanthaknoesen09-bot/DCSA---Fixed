...
const reviews = [
  {
    ...
    author: "Lindy Jonker",
    rating: 5,
    text: "DC Sam - Debt Counselling & Credit Repair has been life-changing. Sam listened, understood my situation, and created a plan I could actually follow. No judgment, just real help.",
  ...
  },
  {
    ...
    rating: 5,
    text: "Best decision I made was reaching out to DC Sam. Sam makes you feel heard and understood. Professional and kind.",
    source: "Google Reviews",
    sourceUrl: "https://g.page/r/CWOXo2cj2ZfyEBM/review",
    tag: "Self-Employed",
  },
  ...
  },
  {
    ...
    rating: 5,
    text: "Transparent, honest, and caring. DC Sam provides real solutions, not quick fixes. Highly recommend.",
    source: "Google Reviews",
    sourceUrl: "https://g.page/r/CWOXo2cj2ZfyEBM/review",
