              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <Button className="w-full py-6 text-lg font-bold"
                          ...
                          asChild>
                    <a href={`https://wa.me/27719006298?text=Hi DCSA (Debt Clear SA (Pty) Ltd)! I've used the preview tool. My estimated total debt is R${currentTotal}. I'd like to chat about my options.`}>
