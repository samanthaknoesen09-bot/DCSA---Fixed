        ...
        <CardContent className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3 p-4 bg-[#4DB6AC]/5 rounded-lg">
                ...
                <Label htmlFor="consentCredit" className="font-normal cursor-pointer text-sm leading-relaxed">
                  I authorize DCSA (Debt Clear SA (Pty) Ltd) to access my credit reports from all major credit bureaus in South Africa to assess
              ...
              <div className="flex items-start space-x-3 p-4 bg-[#4DB6AC]/5 rounded-lg">
                ...
                <Label htmlFor="consentTerms" className="font-normal cursor-pointer text-sm leading-relaxed">
                  I understand that credit repair is a process that takes time and results may vary. DCSA (Debt Clear SA (Pty) Ltd) will work
              ...
              <div className="flex items-start space-x-3 p-4 bg-[#4DB6AC]/5 rounded-lg">
                ...
                <Label htmlFor="consentPrivacy" className="font-normal cursor-pointer text-sm leading-relaxed">
                  I consent to DCSA (Debt Clear SA (Pty) Ltd) storing and processing my personal information in accordance with POPIA regulations
          ...
          <div className="pt-6 border-t">
            ...
            <p className="text-sm text-center text-muted-foreground mt-4">
              By submitting this form, your information will be sent securely to Sam at DCSA (Debt Clear SA (Pty) Ltd).
            </p>
          </div>
        </CardContent>
      </Card>
