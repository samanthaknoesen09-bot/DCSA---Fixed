              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3 p-4 bg-white border-2 border-gray-200 hover:border-[#4DB6AC]/30 rounded-lg transition-colors">
                  ...
                  <Label htmlFor="dec5" className="text-sm leading-relaxed cursor-pointer">
                    I/We confirm that the Debt Review Process and Fee Structure has been explained and is understood and accepted. I/We authorize DCSA (Debt Clear SA (Pty) Ltd) and its agents to process and store my/our personal information in accordance with POPI Act.
                  </Label>
                </div>
              </div>
