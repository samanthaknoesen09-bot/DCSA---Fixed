...
export async function POST(request: NextRequest) {
  try {
    ...
    // Use environment variable for calendar email (secure, not exposed to clients)
    const calendarEmail = process.env.CALENDAR_EMAIL || "samantha.knoesen09@gmail.com"
