...
export const metadata: Metadata = {
  title: "FAQ - Frequently Asked Questions | DCSA (Debt Clear SA (Pty) Ltd) Debt Counselling",
  description:
    "Find answers to common questions about debt counselling, credit repair, and our services. Learn about the debt review process, costs, and how DCSA (Debt Clear SA (Pty) Ltd) can help you.",
  keywords: [
    "debt counselling FAQ",
    "debt review questions",
    "DCSA (Debt Clear SA (Pty) Ltd) FAQ",
  ...
  openGraph: {
    title: "Frequently Asked Questions - DCSA (Debt Clear SA (Pty) Ltd) Debt Counselling",
...
export default function FAQPage() {
  const jsonLd = {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: "What does DCSA (Debt Clear SA (Pty) Ltd) offer?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "DCSA (Debt Clear SA (Pty) Ltd) offers two main services: Debt Counselling (Debt Review) to restructure your debt into one affordable payment with legal protection, and Credit Repair to help you understand and improve your credit score. We provide compassionate, judgment-free support with free consultations.",
        },
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes, DCSA (Debt Clear SA (Pty) Ltd) is fully registered with the National Credit Regulator (NCR). You can verify our registration (NCRDC3995) on the NCR website.",
        },
      },
    ],
  }
          ...
          <div className="mb-12">
            ...
            <Accordion type="multiple" className="space-y-4">
              <AccordionItem value="what-is-dcsa" className="border rounded-lg px-6 bg-white">
                <AccordionTrigger className="text-left">What is DCSA (Debt Clear SA (Pty) Ltd) and what do you offer?</AccordionTrigger>
                <AccordionContent className="text-[#0D3B66]/80 leading-relaxed">
                  We&apos;re DCSA (Debt Clear SA (Pty) Ltd) &mdash; a professional, NCR-registered debt counselling practice (NCRDC3995). We offer 
              ...
              <AccordionItem value="who-can-help" className="border rounded-lg px-6 bg-white">
                <AccordionTrigger className="text-left">Who can benefit from DCSA (Debt Clear SA (Pty) Ltd)&apos;s services?</AccordionTrigger>
                <AccordionContent className="text-[#0D3B66]/80 leading-relaxed">
              ...
              <AccordionItem value="how-start" className="border rounded-lg px-6 bg-white">
                <AccordionTrigger className="text-left">How do I get started with DCSA (Debt Clear SA (Pty) Ltd)?</AccordionTrigger>
                <AccordionContent className="text-[#0D3B66]/80 leading-relaxed">
