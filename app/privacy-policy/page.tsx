...
export const metadata: Metadata = {
  title: "Privacy Policy | DCSA (Debt Clear SA (Pty) Ltd) - Debt Counselling South Africa",
  description: "DCSA (Debt Clear SA (Pty) Ltd)'s privacy policy and POPIA compliance. Learn how we protect your personal information.",
  robots: {
    index: true,
    follow: true,
  },
          ...
          <div className="prose prose-slate max-w-none space-y-8">
            <section>
              ...
              <p className="text-[#0D3B66]/80 leading-relaxed">
                DCSA (Debt Clear SA (Pty) Ltd) (Debt Counselling South Africa) is committed to protecting your privacy and complying with the
