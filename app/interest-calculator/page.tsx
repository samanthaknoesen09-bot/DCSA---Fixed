    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Free Interest Calculator South Africa - DCSA (Debt Clear SA (Pty) Ltd)",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Free Interest Calculator South Africa | DCSA (Debt Clear SA (Pty) Ltd)",
    description:
...
export default function InterestCalculatorPage() {
  ...
  const jsonLd = {
    ...
    name: "DCSA (Debt Clear SA (Pty) Ltd) Interest Calculator",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto mt-12 prose prose-slate">
          ...
          <p className="text-[#0D3B66]/80 mb-4">
            Through professional debt counselling, DCSA (Debt Clear SA (Pty) Ltd) can negotiate with your creditors to reduce
          ...
          <div className="bg-[#4DB6AC]/10 border-l-4 border-[#4DB6AC] p-6 rounded-r-lg mt-8">
            ...
            <p className="text-[#0D3B66]/80 mb-4">
              ...
              monthly payments, DCSA (Debt Clear SA (Pty) Ltd) can help. Book a free consultation to see how debt counselling
