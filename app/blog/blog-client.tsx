...
const fallbackPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: "Did you know that debt review can reduce your monthly payments by up to 45%? It's a legal process that protects you from creditors while you get back on your feet. During debt review, you make one affordable monthly payment, and we distribute it to your creditors on your behalf. Learn more about how DCSA (Debt Clear SA (Pty) Ltd) can help you regain financial freedom.",
          ...
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <div className="mt-10 inline-flex items-center gap-4 bg-white/80 backdrop-blur-sm px-6 py-4 rounded-2xl shadow-sm">
              ...
              <div className="text-left">
                <p className="font-semibold" style={{ color: colors.charcoal }}>Written by Sam &amp; the DCSA (Debt Clear SA (Pty) Ltd) Team</p>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      (window.location.href =
                        "mailto:info@dcsam.co.za?subject=Free Consultation Request&body=Hi DCSA (Debt Clear SA (Pty) Ltd) team, I would like to schedule a free consultation to discuss my debt situation.")
                    }
                  >
