          ...
          <div className="container mx-auto max-w-4xl">
            <div className="text-center space-y-8">
              ...
              <div className="space-y-6">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-balance" style={{ color: colors.charcoal }}>
                  When your salary disappears before month-end.
                </h1>
                
                <p className="text-lg md:text-xl leading-relaxed max-w-2xl mx-auto text-pretty" style={{ color: colors.charcoal }}>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                  <Button 
                    size="lg" 
                    className="rounded-lg font-semibold text-white hover:opacity-90 transition-all duration-300 transform hover:scale-105 shadow-lg h-14 px-8 text-base"
                  ...
                  <Button 
                    size="lg" 
                    className="rounded-lg font-semibold bg-green-600 hover:bg-green-700 text-white transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center gap-2 h-14 px-8 text-base"
                    asChild
                  >
                ...
                <p className="text-sm font-medium italic" style={{ color: colors.warmGrey }}>
