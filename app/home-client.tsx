...
const services = [
  { title: "❤️ Debt counselling", text: "Can't keep up with your monthly repayments? Start here with a free first look.", href: "/debt-help", label: "Start here" },
  { title: "🔴 Debt review", text: "Need a structured plan? One reduced repayment under the National Credit Act.", href: "/get-started", label: "Ask about debt review" },
  ...
  { title: "🚩 Flag removal", text: "Finished debt review but the flag is still showing? Eligibility applies — removal depends on your circumstances, never guaranteed.", href: "/get-started", label: "Check my eligibility" },
]
