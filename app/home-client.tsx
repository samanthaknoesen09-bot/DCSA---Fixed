        ...
        <section className="relative py-16 md:py-28 px-4" style={{ 
          ...
          <div className="container mx-auto max-w-3xl space-y-6 text-center">
            ...
            <p className="text-lg md:text-xl text-pretty leading-relaxed" style={{ color: colors.charcoal }}>
              If your accounts are controlling your life, you deserve to take control back. We help South Africans find their feet again.
            </p>
            ...
            <div className="space-y-4 pt-4">
              ...
              <p className="text-base text-pretty" style={{ color: colors.warmGrey }}>
                With a proper plan — explained clearly, handled legally, and done properly. And you won't have to do it alone. (We're human, promise.)
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
              <Button 
                ...
                asChild
              >
                <Link href={WHATSAPP_URL + "?text=Hi%20Sam!%20I'd%20like%20to%20chat%20about%20my%20options"}>
