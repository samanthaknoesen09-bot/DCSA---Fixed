            ...
            <CardContent className="space-y-6">
              <div className="space-y-4 p-4 bg-[#0D3B66]/5 rounded-lg">
                ...
                <p className="text-sm text-[#0D3B66]/80 leading-relaxed">
                  I hereby grant DCSA (Debt Clear SA (Pty) Ltd) (Debt Counselling South Africa), NCR Registered Debt Counsellor NCRDC3995, 
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <Label htmlFor="poaAgreement" className="text-sm leading-relaxed cursor-pointer">
                    I grant DCSA (Debt Clear SA (Pty) Ltd) power of attorney to act on my behalf in all debt review matters *
                  </Label>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <Label htmlFor="consentToContactCreditors" className="text-sm leading-relaxed cursor-pointer">
                    I consent to DCSA (Debt Clear SA (Pty) Ltd) contacting my credit providers on my behalf *
                  </Label>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <Label htmlFor="consentToProcessPersonalInfo" className="text-sm leading-relaxed cursor-pointer">
                    I consent to DCSA (Debt Clear SA (Pty) Ltd) processing my personal information in accordance with POPIA *
                  </Label>
                </div>
