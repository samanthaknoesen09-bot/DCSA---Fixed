      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-[#0D3B66]/70 mb-4">
            Transfer your debt review from another debt counsellor to DCSA (Debt Clear SA (Pty) Ltd)
          </p>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={4}
                  placeholder="Please tell us why you want to transfer to DCSA (Debt Clear SA (Pty) Ltd)..."
                />
              </div>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4 p-4 bg-[#0D3B66]/5 rounded-lg">
                ...
                <p className="text-sm text-[#0D3B66]/80 leading-relaxed">
                  I hereby authorize DCSA (Debt Clear SA (Pty) Ltd) (Debt Counselling South Africa) to contact my current debt counsellor 
                  and initiate the transfer of my debt review file. I understand that DCSA (Debt Clear SA (Pty) Ltd) will act as my new 
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <Label htmlFor="authorizeContactCurrentDC" className="text-sm leading-relaxed cursor-pointer">
                    I authorize DCSA (Debt Clear SA (Pty) Ltd) to contact my current debt counsellor to request my transfer *
                  </Label>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <Label htmlFor="authorizeTransferOfRecords" className="text-sm leading-relaxed cursor-pointer">
                    I authorize the transfer of all my debt review records to DCSA (Debt Clear SA (Pty) Ltd) *
                  </Label>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <Label htmlFor="consentToProcessPersonalInfo" className="text-sm leading-relaxed cursor-pointer">
                    I consent to DCSA (Debt Clear SA (Pty) Ltd) processing my personal information for the transfer *
                  </Label>
                </div>
              </div>
